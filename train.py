...
if __name__ == '__main__':
    ...
    parser.add_argument('--labels', type=str_to_list_fn(str,','), help='labels for model', default='age')
    ...
    parser.add_argument('--number_classes', type=int, default=7, help="age = 12")
    ...
    # Training parameters
    parser.add_argument("--output_dir", default="trained_models", help="Directory for the trained model, automatically defined if not given.")
...
#    parser.add_argument('--loss', default='categorical_crossentropy', help='loss function')
    ...
    # Model parameters
    parser.add_argument('--model', type=str, default="resnet", choices=['resnet', 'resnet101','vggface', 'mobilenet'],help="Model type to use, vggface or resnet50.")
